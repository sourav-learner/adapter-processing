...
public abstract class InterconnectMarginFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(InterconnectMarginFileProcessor.class);
