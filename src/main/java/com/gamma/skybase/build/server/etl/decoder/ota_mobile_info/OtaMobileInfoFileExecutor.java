...
public class OtaMobileInfoFileExecutor extends OtaMobileInfoFileProcessor {
    private static final Logger logger = LoggerFactory.getLogger(OtaMobileInfoFileExecutor.class);
    private List<LinkedHashMap<String, Object>> jsonRecords;
    String[] headers = new String[]{"DATA_DAY" , "TIMESTAMP" , "AUTHOR" , "CHANNEL" , "PROVIDERID" , "ENTITYNAME" , "OPERATIONTYPE" , "PROVIDERNAME" , "IMSI" , "IMEI" , "MSISDN" , "PREVIOUSVALUE" , "REGION" , "PROCS_FILE" , "PROCS_TIME"};
    ...
    private void processRecord(LinkedHashMap<String, Object> record, IEnrichment enrichment) throws Exception {
        if (enrichment != null) {
            ...
            if (response.isResponseCode()) {
                ...
                if (data != null)
                    handleEvents("FCT_OTA_MOBILE_INFO", data);
            }
        }
    }
