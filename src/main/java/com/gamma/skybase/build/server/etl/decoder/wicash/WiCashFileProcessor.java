...
public abstract class WiCashFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(WiCashFileProcessor.class);
