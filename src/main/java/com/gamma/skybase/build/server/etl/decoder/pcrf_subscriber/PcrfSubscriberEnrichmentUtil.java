...
public class PcrfSubscriberEnrichmentUtil extends LebaraUtil {
    ...
    public PcrfSubscriberEnrichmentUtil(LinkedHashMap<String, Object> record) {
        super(record);
    }

    public static PcrfSubscriberEnrichmentUtil of(LinkedHashMap<String, Object> record) {
        return new PcrfSubscriberEnrichmentUtil(record);
    }
