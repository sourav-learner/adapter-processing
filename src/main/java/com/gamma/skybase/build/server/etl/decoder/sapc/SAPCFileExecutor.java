package com.gamma.skybase.build.server.etl.decoder.sapc;
...
import com.gamma.skybase.build.server.etl.decoder.mmsc.MMSCFileProcessor;
...
public class SAPCFileExecutor extends SAPCFileProcessor {

    private static final Logger logger = LoggerFactory.getLogger(SAPCFileExecutor.class);
    private Gson gson;
    ...
    public void parseFile(String fileName) throws Exception {
        ...
        String[] headers = {"SERVED_MSISDN", "COL_2", "COL_3", "COL_4", "COL_5", "COL_6", "COL_7", "GROUP_ID", "PRIORITY",
                "START_DATE", "END_DATE", "COL_12", "COL_13", "COL_14", "COL_15"};
