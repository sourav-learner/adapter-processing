...
public class CbsSubscriptionFileExecutor extends CbsSubscritionFileProcessor {
    private static final Logger logger = LoggerFactory.getLogger(CbsSubscriptionFileExecutor.class);
    ...
    private void processRecord(LinkedHashMap<String, Object> record, IEnrichment enrichment) throws Exception {
        if (enrichment != null) {
            ...
            if (response.isResponseCode()) {
                ...
                if (data != null)
                    handleEvents("FCT_CBS_SUBSCRIPTION", data);
            }
        }
    }
