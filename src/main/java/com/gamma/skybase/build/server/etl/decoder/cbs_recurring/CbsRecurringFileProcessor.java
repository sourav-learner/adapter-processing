...
public abstract class CbsRecurringFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(CbsRecurringFileProcessor.class);
