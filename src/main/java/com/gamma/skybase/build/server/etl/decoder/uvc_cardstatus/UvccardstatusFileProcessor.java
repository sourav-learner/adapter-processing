...
public abstract class UvccardstatusFileProcessor  extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(UvccardstatusFileProcessor.class);
