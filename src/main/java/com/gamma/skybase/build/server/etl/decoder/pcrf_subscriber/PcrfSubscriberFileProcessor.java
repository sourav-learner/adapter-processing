...
public abstract class PcrfSubscriberFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(PcrfSubscriberFileProcessor.class);
