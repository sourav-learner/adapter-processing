...
public class PcrfQuotaEnrichmentUtil extends LebaraUtil {
    ...
    public PcrfQuotaEnrichmentUtil(LinkedHashMap<String, Object> record) {
        super(record);
    }

    public static PcrfQuotaEnrichmentUtil of(LinkedHashMap<String, Object> record) {
        return new PcrfQuotaEnrichmentUtil(record);
    }
