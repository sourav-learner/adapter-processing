...
//import com.gamma.skybase.config.datasource.FileDataSource;
...
public abstract class PostMedChargingFileProcessor extends AFileSourceDecoder {
    private static final Logger logger = LoggerFactory.getLogger(PostMedChargingFileProcessor.class);
