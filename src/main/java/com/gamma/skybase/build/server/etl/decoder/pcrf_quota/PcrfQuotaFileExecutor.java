package com.gamma.skybase.build.server.etl.decoder.pcrf_quota;
...
public class PcrfQuotaFileExecutor extends PcrfQuotaFileProcessor {
    private static final Logger logger = LoggerFactory.getLogger(PcrfQuotaFileExecutor.class);
    private List<LinkedHashMap<String, Object>> jsonRecords;
    String[] headers = new String[]{"QUOTAID" , "QUOTANAME" , "SERVICEID" , "RGID" , "INITIALVALUE" , "PERCENT" , "BILLINGCYCLEMODE" , "BILLINGCYCLETIME" , "RESETTYPE" , "RESETWEEK" , "RESETDAY" , "RESETTIME" , "BALANCERESETMETHOD" , "LEVEL1" , "LEVEL2" , "LEVEL3" , "LEVEL4" , "TYPE" , "CLASS" , "ACCUMULATIONTYPE" , "DESCRIPTION" , "PERIODLENGTH" , "RESETTIMETYPE" , "DESTINATIONPCEF" , "NOTIFICATIONID" , "EDRREPORT" , "LEVEL5" , "LEVEL6" , "LEVEL7" , "LEVEL8" , "LEVEL9" , "LEVEL10" , "CUSTOMLEVEL1" , "CUSTOMLEVEL2" , "CUSTOMLEVEL3"};
    ...
    private void processRecord(LinkedHashMap<String, Object> record, IEnrichment enrichment) throws Exception {
        if (enrichment != null) {
            ...
            if (response.isResponseCode()) {
                ...
                if (data != null)
                    handleEvents("FCT_PCRF_QUOTA", data);
            }
        }
    }
