...
public class PcrfServiceEnrichmentUtil extends LebaraUtil {
    ...
    public PcrfServiceEnrichmentUtil(LinkedHashMap<String, Object> record) {
        super(record);
    }

    public static PcrfServiceEnrichmentUtil of(LinkedHashMap<String, Object> record) {
        return new PcrfServiceEnrichmentUtil(record);
    }
