...
public class PcrfSubscriberFileExecutor extends PcrfSubscriberFileProcessor {
    private static final Logger logger = LoggerFactory.getLogger(PcrfSubscriberFileExecutor.class);
    private List<LinkedHashMap<String, Object>> jsonRecords;
    String[] headers = new String[]{"SID" , "SUBSCRIBERSN" , "SUBSCRIBERIDENTIFIER" , "SERVED_MSSIDN" , "STATUS" , "HOMESRVZONE" , "PAIDTYPE" , "CATEGORY" , "STATION" , "EMAILADDRESS" , "CONTACTMETHOD" , "BILLCYCLYDAY" , "DOMAINID"};
    ...
    private void processRecord(LinkedHashMap<String, Object> record, IEnrichment enrichment) throws Exception {
        if (enrichment != null) {
            ...
            if (response.isResponseCode()) {
                ...
                if (data != null)
                    handleEvents("FCT_PCRF_SUBSCRIBER", data);
            }
        }
    }
