...
public abstract class CommonAsciiFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(CommonAsciiFileProcessor.class);
