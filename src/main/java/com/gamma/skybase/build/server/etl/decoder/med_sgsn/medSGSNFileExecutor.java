...
public class medSGSNFileExecutor extends medSGSNFileProcessor {
    ...
    String[] headers = new String[]{"SEQUENCENUMBER" , "TOTALTYPE" , "CALLINDICATOR" , "ACCESSPOINTNAME" , "MSISDN" , "DATAVOLUMEINCOMING" , "DATAVOLUMEOUTGOING" , "MSISDN" , "GGSNAddress" , "SGSNAddress" , "SERVICETYPE" , "CALLEVENTSTARTTIMESTAMP" , "TOTALCALLEVENTDURATION" , "PARTIALCALLINDICATOR" , "IMSI" , "SERVICEID" , "EQUIPMENTIDA" , "CELLNAME" , "LOCATIONAREAID" , "PDPTYPE" , "PDPAddress" , "CAUSEFORTERMINATION" , "CHARGINGID" , "CALLREFERENCENUMBER" , "FLEXI_COL_1"};
