...
public abstract class JinnyPSMSFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(JinnyPSMSFileProcessor.class);
