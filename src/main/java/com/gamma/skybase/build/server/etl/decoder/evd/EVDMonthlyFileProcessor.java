...
public abstract class EVDMonthlyFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(EVDMonthlyFileProcessor.class);
