...
public class RatedTapinRecordEnrichment implements IEnrichment {

    private static final Logger logger = LoggerFactory.getLogger(RatedTapinRecordEnrichment.class);
    ...
    public LinkedHashMap<String, Object> transform(LinkedHashMap<String, Object> data) {
        ...
        try{
            ...
            String chargeTimestamp = String.valueOf(data.get("start_time_timestamp"));
            ...
            output.put("start_time_timestamp", formatter.format(chargeTimestampDate.toInstant()));
        ...
        //s_p_number_address - served
        String netElementAddress = String.valueOf(data.get("net_element_address"));
        ReferenceDimDialDigit sddk = transformationLib.getDialedDigitSettings(netElementAddress);
        if (sddk != null) {
        ...
        String match = transformationLib.getDimLookupCRMSubscriber(servedMsisdn);
        String srvTypeKey = match == null ? "6" : "5";
        output.put("SRV_TYPE_KEY", srvTypeKey);

        //o_p_normed_num_address - other
        Object opNormedNumAddress = data.get("o_p_number_address");
