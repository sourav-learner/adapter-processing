 ...
 */
public abstract class VoucherServerChangeFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(VoucherServerChangeFileProcessor.class);
