package com.gamma.skybase.build.server.etl.decoder.rbt;
...
public class RBTFileExecutor extends RBTFileProcessor {

    private static final Logger logger = LoggerFactory.getLogger(RBTFileExecutor.class);
    private Gson gson;
    ...
    public void parseFile(String fileName) throws Exception {
        ...
        String[] headers = {"TIMESTAMP1","CLIENTTRANSACTIONID","APARTY","ACCESSFLAG","CONTENTPROVIDERID","OPERATIONCODE",
                "NEXTBILLINGDATE","CALLCHARGE","DEFAULTCALLCHARGE","CHANNEL","CP_NAME","CONTENTTYPE",
                "CONTENT_NAME","CONTENT_ID","SUBSCRIBERTYPE","FALLBACKFLAG","SUBSCRIBERSTATUS","SUBSCRIPTIONDATE",
                "SUBSCRIPTIONFLAG","VALIDITY_DAYS","RULENAME","BASICCAUSE","CHARGING_STATUS"};
