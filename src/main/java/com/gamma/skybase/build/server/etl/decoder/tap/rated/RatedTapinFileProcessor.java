...
public abstract class RatedTapinFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(RatedTapinFileProcessor.class);
