...
public abstract class PcrfSubQuotaFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(PcrfSubQuotaFileProcessor.class);
