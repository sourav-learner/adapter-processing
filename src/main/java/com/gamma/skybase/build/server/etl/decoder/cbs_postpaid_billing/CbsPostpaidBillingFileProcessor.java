...
public abstract class CbsPostpaidBillingFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(CbsPostpaidBillingFileProcessor.class);
