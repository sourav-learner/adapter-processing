package com.gamma.skybase.build.server.etl.tx.cudb;
...
public class CUDBRecordEnrichment implements IEnrichment {

    private static final Logger logger = LoggerFactory.getLogger(CUDBRecordEnrichment.class);
