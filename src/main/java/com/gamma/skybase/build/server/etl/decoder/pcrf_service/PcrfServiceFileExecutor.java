package com.gamma.skybase.build.server.etl.decoder.pcrf_service;
...
public class PcrfServiceFileExecutor extends PcrfServiceFileProcessor {
    private static final Logger logger = LoggerFactory.getLogger(PcrfServiceFileExecutor.class);
    private List<LinkedHashMap<String, Object>> jsonRecords;
    String[] headers = new String[]{"SERVICEID" , "SERVICENAME" , "SERVICETYPE" , "APN" , "QOSMODE" , "ACTIVATEDBY" , "PRECEDENCE" , "SPID" , "ISSUBSCRIPTIONFORCED" , "QUOTAID" , "ACCOUNTID" , "DPIPARAMETER" , "ISMETERTOBASIC" , "VPN" , "VALIDFORMDATETIME" , "VALIDUNTILDATETIME" , "DISPLAYNAME" , "PATUNABLE" , "SERVICEURL" , "NEEDAUTH" , "DEFAULTACTIVATED" , "DESCRIPTION" , "STARTNOTIFICATIONID" , "ENDNOTIFICATIONID" , "SUBSCRIPTIONNOTIFICATIONID" , "CHANGENOTIFICATIONID" , "BEFOREEXPIRYNOTIFICATIONID" , "EXPIRYINTERVAL" , "CALCULATETIME" , "DURATIONTYPE" , "DURATIONVALUE"};
    ...
    private void processRecord(LinkedHashMap<String, Object> record, IEnrichment enrichment) throws Exception {
        if (enrichment != null) {
            ...
            if (response.isResponseCode()) {
                ...
                if (data != null)
                    handleEvents("FCT_PCRF_SERVICE", data);
            }
        }
    }
