...
public abstract class CRMLookupFileProcessor extends AFileSourceDecoder {

    private static final Logger logger = LoggerFactory.getLogger(CRMLookupFileProcessor.class);
